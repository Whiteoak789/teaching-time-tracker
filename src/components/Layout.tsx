...
import {
  Apple, ArchiveRestore, Bell, CalendarDays, ChartNoAxesCombined, ClipboardCheck, FileBarChart,
  FolderSync, Goal, Grid2X2, Menu, NotebookPen, Plus, Search, Settings,
} from "lucide-react";
